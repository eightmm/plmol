...
# Surface defaults
SURFACE_DEFAULT_GRID_DENSITY = 2.5
SURFACE_DEFAULT_THRESHOLD = 0.5
SURFACE_DEFAULT_SHARPNESS = 1.5
SURFACE_DEFAULT_MAX_MEMORY_GB = 1.0
SURFACE_DEFAULT_CUDA_CLEANUP_INTERVAL = 8
